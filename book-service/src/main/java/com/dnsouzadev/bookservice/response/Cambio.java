package com.dnsouzadev.bookservice.response;
...
public class Cambio implements Serializable {
    ...
    public Cambio(Long id, String from, String to, Double conversionFactor, Double convertedValue, Double amount, String environment) {
        this.id = id;
        this.from = from;
        this.to = to;
